...
def get_user_list(config, key):
    with open('{}/SteelaQueenBot/{}'.format(os.getcwd(), config),
              'r') as json_file:
...
class Config(object):
    ...
    TOKEN = "2021201316:AAFme0smChuqaL2D2x8HTD5IJwQN1Kpx5Cg"  #This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    SQLALCHEMY_DATABASE_URI = 'postgres://ruuemxke:17mFgMB5kH5fZyB73sB6BvtFn3PWq4ZR@castor.db.elephantsql.com/ruuemxke' #do you hub your old heroku app database_URL then put here, most use 25days ago sql
