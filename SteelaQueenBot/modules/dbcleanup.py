...
import SteelaQueenBot.modules.sql.global_bans_sql as gban_sql
import SteelaQueenBot.modules.sql.users_sql as user_sql
from SteelaQueenBot import DEV_USERS, OWNER_ID, dispatcher
