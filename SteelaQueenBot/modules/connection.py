...
import SteelaQueenBot.modules.sql.connection_sql as sql
from SteelaQueenBot import dispatcher, DRAGONS, DEV_USERS
from SteelaQueenBot.modules.helper_funcs import chat_status
