...
import html
import requests
import SteelaQueenBot.modules.sql.chatbot_sql as sql
...
from SteelaQueenBot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from SteelaQueenBot import dispatcher, updater, SUPPORT_CHAT
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Anjal Chatbot disable by {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Anjal Chatbot enable by {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
