...
import urllib.parse
import requests
from SteelaQueenBot import (DEV_USERS, OWNER_ID, DRAGONS, SUPPORT_CHAT, DEMONS,
                          TIGERS, WOLVES, dispatcher,updater)
from SteelaQueenBot.__main__ import STATS, TOKEN, USER_INFO
...
from SteelaQueenBot.modules.helper_funcs.chat_status import sudo_plus, user_admin
