...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "black"
    shadowcolor = "blue"
    fnt = glob.glob("./AnjalRobot/SteelaQueenBot/resources/ImageEditor/logofonts/*")
    ...
    fname = "logo.png"
    img.save(fname, "png")
    anjal = [[Button.url("MADE BY ANJAL", "t.me/anjalrobot")]]
    await tbot.send_file(event.chat_id, file=fname,buttons=anjal)
