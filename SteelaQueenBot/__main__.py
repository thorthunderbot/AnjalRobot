...
import SteelaQueenBot.modules.sql.users_sql as sql
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("SteelaQueenBot.modules." +
                                              module_name)
    ...
    if query.data == "Steela_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Anjal*, a powerful group management bot built to help you manage your group easily.
                 ...
                 If you have any question about Anjal, let us know at @NobisukiSupport.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@NobisukiSupport","[Back To Online](https://telegra.ph/file/434967e94c3dda08b34ac.jpg)", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(
